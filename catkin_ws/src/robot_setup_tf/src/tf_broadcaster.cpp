...
int main(int argc, char** argv){
  ...
  //transform_1.setOrigin( tf::Vector3( 0.0, 0.0, 0.138586714864) );
  ...
  while(n.ok()){
    ...
    broadcaster.sendTransform(tf::StampedTransform(tf::Transform(transform_1), ros::Time::now(), "map", "GhostPioneer_p3dxTarget"));
