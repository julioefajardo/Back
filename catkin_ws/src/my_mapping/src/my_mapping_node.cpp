...
int main(int argc, char** argv){
  ...
  ros::NodeHandle nh_;
  ros::Subscriber scanSub = nh_.subscribe<sensor_msgs::LaserScan>("/vrep/front_scan",10,&processLaserScan);
  ros::Subscriber poseSub = nh_.subscribe<nav_msgs::Odometry>("/odometry/pose",10,&processPose);
  ros::Publisher map_pub = nh_.advertise<nav_msgs::OccupancyGrid>("/map", 1, true);
